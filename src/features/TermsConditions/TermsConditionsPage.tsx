...
/**
 * A server component: the governing text of every warranty claim must be in
 * the HTML, and the one address, phone and email come from SITE so the site
 * publishes a single NAP.
 */
          ...
          <section className="mx-auto max-w-4xl px-6 pb-24 sm:px-10 sm:pb-32 lg:px-8">
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <ol className="space-y-4">
                ...
                {[
                  ...
                  `8. Notify Silver Storey via phone at ${SITE.phoneDisplay} or email at ${SITE.email} within 7 days of a defect that comes to notice, such as visual damage or malfunctioning component. Notification post this time will void the Silver Storey warranty.`,
              ...
              <ol className="space-y-4">
                <li className="text-sm text-black sm:text-base">
                  <span>
                    ...
                    telephonically lodges their warranty policy with Silver
                    Storey by contacting us at {SITE.phoneDisplay} and
                    furnishing all the purchase and personal details requested
                    by Silver Storey. In order for this warranty policy to be
                    valid, the registration needs to be done within 7 (seven)
                    days from the day of handover of the project or the day the
                    customer moves in, whichever is earlier.
                  </span>
                </li>
                <li className="text-sm text-black sm:text-base">
                  2. Claim Settlement: After settlement of any claim, the
                  warranty period will not start afresh.
                </li>
                <li className="text-sm text-black sm:text-base">
                ...
                <li className="text-sm text-black sm:text-base">
                  ...
                  liable for any indirect or consequential loss or damages to
                  the customer. The customer&apos;s exclusive and sole remedy
                  under this warranty policy shall be as mentioned in this
                  clause.
                </li>
                <li className="text-sm text-black sm:text-base">
                  6. Accommodation During Repairs: Silver Storey is not liable
                  to provide any alternative accommodation during any repair
                  work. Customers shall make their own arrangements, if
                  required.
                </li>
                <li className="text-sm text-black sm:text-base">
                  <span>
                    7. Exclusions: The warranty policy shall not cover any
                    defects arising out of factors out of control of Silver
                    Storey, including but not limited to:
                  </span>
                  <ul className="mt-2 ml-5 list-none space-y-1.5">
                    {[
                ...
                <li className="text-sm text-black sm:text-base">
                  <span>
                    11. Repair Control: Silver Storey, in its sole discretion,
                    is entitled to:
                  </span>
                  <ul className="mt-2 ml-5 list-none space-y-1.5">
                    {[
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <ol className="space-y-4">
                ...
                <li className="text-sm text-black sm:text-base">
                  <span>
                    4. False Ceiling Failure: False ceiling failure shall mean
                ...
                <li className="text-sm leading-relaxed text-black sm:text-base">
                  5. False Ceiling System: The customer has used the entire
                  false ceiling system recommended and executed by Silver
                  Storey. The false ceiling should have been done with the usage
                  of Silver Storey approved brands and all materials utilized
                  shall be of the same manufacturer. Any mix-use of other brands
                  shall make the warranty null and void.
                </li>
                <li className="text-sm text-black sm:text-base">
                  <span>
                    6. Void Warranty: The warranty policy shall be void in the
              ...
              <ol className="space-y-4">
                ...
                <li className="text-sm text-black sm:text-base">
                  <span>
                    ...
                    document the words &ldquo;electrical failure&rdquo; shall
                    mean any of the following occurring, subject to the other
                ...
                <li className="text-sm leading-relaxed text-black sm:text-base">
                  ...
                  electrical wiring recommended and laid by Silver Storey
                  provided the customer had used appropriate appliances in the
                  usage ports/points.
                </li>
                <li className="text-sm text-black sm:text-base">
                  <span>
                ...
                <li className="text-sm leading-relaxed text-black sm:text-base">
                  7. Replacement Cost: The replacement cost will include the
                  cost of electrical items including wiring, switches, conduits
                  (if any), and labor required to set right the concerned
                  failure only, at the time of lodgement of claim.
                </li>
              </ol>
            </div>
            ...
            {/* ══ Contact Info ══ */}
            <address className="text-sm leading-relaxed text-black not-italic sm:text-base">
              <p className="mb-1">
              ...
              <p>
                Email:{' '}
                <a href={`mailto:${SITE.email}`} className="underline-offset-2">
                  {SITE.email}
                </a>
              </p>
            </address>
